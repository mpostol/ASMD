...
namespace CAS.UA.Model.Designer.Controls.NodeObserver
{
  internal class MainController
  {
    ...
    //TODO It should be private; the procedure for registering all observers must be the same.
    internal event SelectedItemIsChangedEventHandler SelectedItemIsChanged;
    internal void RaiseSelectedItemIsChanged( object sender, SelectedItemEventArgs e )
    {
      ...
      if ( SelectedItemIsChanged != null )
      {
        SelectedItemIsChanged( sender, e );
      }
    }
    #endregion public /internal
  }
}
