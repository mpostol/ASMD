//////////////////////////////////////////////////////////////////////////////
//
// NOTE: This file has been tweaked to report errors via a message dialog.
//
//       To reuse this code in your applications you'll want to grab the
//       latest version from:
//
    ...
    public sealed class Parser
    {
        ...
        public static bool ParseArgumentsWithUsage(string [] arguments, object destination)
        {
            if (Parser.ParseHelp(arguments) || !Parser.ParseArguments(arguments, destination))
            {
                ...
                MyApp.StartupError(Parser.ArgumentsUsage(destination.GetType()));
                return false;
            }
