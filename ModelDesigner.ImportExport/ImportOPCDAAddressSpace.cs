...
namespace CAS.UA.Model.Designer.ImportExport
{
    ...
    public static class ImportOPCDAAddressSpace
    {
                ...
                case Opc.Da.euType.analog:
                    {
                        ...
                        if (higheu != null && loweu != null)
                        {
                            OpcUaModelCompiler.PropertyDesign prop = new OpcUaModelCompiler.PropertyDesign()
                            {
                                ...
                                DefaultValue = UAOOIOPCUACommon.Types.Range.CreateRange(higheu, loweu).XmlElement,
                                ValueRank = OpcUaModelCompiler.ValueRank.Scalar,
        ...
        //ObjectTypes
        private static XmlQualifiedName GetFolderType()
        { return CreateXmlQualifiedName(BrowseNames.FolderType); }

        //DataTypes
        private static XmlQualifiedName GetBaseDataType()
        { return CreateXmlQualifiedName(BrowseNames.BaseDataType); }

        //VariableType
        private static XmlQualifiedName GetBaseDataVariableType()
        { return CreateXmlQualifiedName(Opc.Ua.BrowseNames.BaseDataVariableType); }
        ...
        //Properties
        private static XmlQualifiedName GetPropertyType()
        { return CreateXmlQualifiedName(BrowseNames.PropertyType); }
